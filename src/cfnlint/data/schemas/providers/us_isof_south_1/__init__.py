...
cached: list[str] = [
    ...
    "aws-bedrock-automatedreasoningpolicy.json",
    "aws-bedrock-automatedreasoningpolicyversion.json",
    ...
    "aws-bedrock-intelligentpromptrouter.json",
    "aws-bedrock-knowledgebase.json",
    "aws-bedrock-prompt.json",
    "aws-bedrock-promptversion.json",
    "aws-bedrockagentcore-browsercustom.json",
    "aws-bedrockagentcore-codeinterpretercustom.json",
    "aws-bedrockagentcore-gateway.json",
    "aws-bedrockagentcore-gatewaytarget.json",
    "aws-bedrockagentcore-memory.json",
    "aws-bedrockagentcore-runtime.json",
    "aws-bedrockagentcore-runtimeendpoint.json",
    "aws-billing-billingview.json",
    ...
    "aws-inspectorv2-codesecurityintegration.json",
    "aws-inspectorv2-codesecurityscanconfiguration.json",
    ...
    "aws-iotsitewise-computationmodel.json",
    ...
    "aws-lightsail-disksnapshot.json",
    "aws-lightsail-distribution.json",
    "aws-lightsail-domain.json",
    "aws-lightsail-instance.json",
    "aws-lightsail-instancesnapshot.json",
    ...
    "aws-notifications-organizationalunitassociation.json",
    "aws-notificationscontacts-emailcontact.json",
    "aws-oam-link.json",
    "aws-oam-sink.json",
    "aws-observabilityadmin-organizationcentralizationrule.json",
    "aws-observabilityadmin-organizationtelemetryrule.json",
    "aws-observabilityadmin-telemetryrule.json",
    "aws-odb-cloudautonomousvmcluster.json",
    "aws-odb-cloudexadatainfrastructure.json",
    "aws-odb-cloudvmcluster.json",
    "aws-odb-odbnetwork.json",
    "aws-odb-odbpeeringconnection.json",
    ...
    "aws-omics-workflowversion.json",
    ...
    "aws-s3express-accesspoint.json",
    ...
    "aws-securityhub-aggregatorv2.json",
    ...
    "aws-ses-mailmanageraddresslist.json",
    ...
    "aws-smsvoice-configurationset.json",
    "aws-smsvoice-optoutlist.json",
    "aws-smsvoice-phonenumber.json",
    "aws-smsvoice-pool.json",
    "aws-smsvoice-protectconfiguration.json",
    "aws-smsvoice-resourcepolicy.json",
    "aws-smsvoice-senderid.json",
    ...
    "aws-ssmquicksetup-lifecycleautomation.json",
    ...
    "aws-wisdom-quickresponse.json",
    "aws-workspaces-connectionalias.json",
    "aws-workspaces-workspace.json",
    "aws-workspaces-workspacespool.json",
    "aws-workspacesinstances-volume.json",
    "aws-workspacesinstances-volumeassociation.json",
    "aws-workspacesinstances-workspaceinstance.json",
    ...
    "aws-workspacesweb-sessionlogger.json",
